...
import * as strings from 'LeavePortalWebPartStrings';
import LeavePortal from './components/LeavePortal';
import { ILeavePortalProps } from './components/ILeavePortalProps';
...
export default class LeavePortalWebPart extends BaseClientSideWebPart<ILeavePortalWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<ILeavePortalProps> = React.createElement(
      LeavePortal,
      {
